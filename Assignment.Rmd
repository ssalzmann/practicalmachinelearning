...
```{r echo=FALSE}
# load data
trainData <- read.csv("D:/Coursera/JH_DataScience/Practical ML/pml-training.csv",na.strings=c(""," ","NA"))
testData <- read.csv("D:/Coursera/JH_DataScience/Practical ML/pml-testing.csv")
